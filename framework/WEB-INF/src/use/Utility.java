...
public class Utility {
  ...
  public static boolean isSave(HttpServletRequest request, HashMap<String, Mapping> mappingUrls, String url)
      throws Exception {
    String reponse = "";
    reponse = mappingUrls.get(url).getMethod();
    return reponse.equals("save");
  }
  ...
  public static void toBase(Object object) throws Exception {
    Method method = object.getClass().getMethod("insert");
